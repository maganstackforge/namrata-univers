...
export default function TermsAndCondition() {
  return (
    <>
      <Helmet>
        {/* Primary SEO */}
        <title>Terms & Conditions | Namrata Universal</title>

        <meta
          name='description'
          content='Read the Terms and Conditions of Namrata Universal for using our website, services, internship programs, and digital solutions.'
        />

        <meta
          name='keywords'
          content='Terms and Conditions, Website Terms, Service Terms, Internship Terms, User Agreement, Namrata Universal Terms'
        />
        ...
        {/* Open Graph */}
        <meta property='og:title' content='Terms & Conditions | Namrata Universal' />

        <meta
          property='og:description'
          content='Review the terms and conditions for using Namrata Universal services, website, and internship programs.'
        />
        ...
        <meta name='twitter:title' content='Terms & Conditions | Namrata Universal' />

        <meta
          name='twitter:description'
          content='Read the terms and conditions related to Namrata Universal services and website usage.'
        />

        {/* Canonical URL */}
        <link rel='canonical' href='https://your-domain.com/terms-and-conditions' />
      </Helmet>
