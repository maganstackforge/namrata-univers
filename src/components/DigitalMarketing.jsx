    ...
    <section id='digitalMarketing' className='flex items-center justify-center flex-col'>
      <div className='w-full flex flex-col justify-center'>
        ...
        <div className='w-10/12 mx-auto sm:max-w-4/5 py-6'>
          ...
          <p>
            Digital marketing has been the need of every business as it helps them in promoting brand of their
            products and services. The digital marketing is very important for enhancing sales. Through
            digital marketing, you can reach your target audience at local and global level. It also helps you
            increasing brand awareness, the various content types are also available in digital marketing to
            showcase your online brand that helps you attract the customers makes them to understand the
            products with the ease. It helps you to increase brand engagement by sharing blog post or a paid
            ad click. Digital marketing helps you in maintaining brand reputation, increasing in brand
            awareness for both large and small sized businesses, competing with large corporations, converting
            the website visitors into paid customers and tracking and taking action. Digital marketing
            strategies are cost effective, affordable and faster that assists you in establishing long term
            ...
            <div className='flex flex-col md:flex-row justify-center items-center gap-8 px-4'>
              <div className='md:w-2/3'>
                <p>
                  ...
                  ads and social media posts. Digital marketing is a vast platform that attracts customers via
                  email, content marketing, search platform, social media and many more. Website marketing,
                  pay-per-click advertising, content marketing, email marketing social media marketing,
                  affiliate marketing, video marketing and SMS messaging are the form of digital marketing.
                  Being digital marketers, we help all types of businesses in promoting the product and
                  services brand and also assist them to stay in touch with their customers and boost sales in
                  this challenging time. We also offer our customers the best services in their budget by
                  adding credits to their account.
                </p>
              </div>
        ...
        <div className='w-4/5 mx-auto'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-8 sm:p-4'>
            <div className='w-full'>
              ...
              <p>
                Digital marketing is the way of advertising and selling the products through the social media
                platforms using internet to promote brands and interact with the potential customers. In other
                words, digital marketing refers to all the efforts to promote products and services through
                digital channels like social media, SEO, emails and mobile apps. Digital marketing involves
                all the electronic devices such as computer, laptop, tablet and mobile Online marketing uses a
                variety of digital online and electronic means to deliver the messages in the form of an
                image, a piece of text or a video.
              </p>
            </div>
            <div className='w-full'>
        ...
        <div className='w-10/12 mx-auto sm:px-8 md:px-10 pb-10'>
          <div className='typeOfDigitalMarketing border-l-1 border-blue-700'>
            ...
            <ul className='px-6 sm:px-10 md:px-20 list-disc'>
              ...
              <li>
                <strong>Search Engine Optimization (SEO)</strong> is the act of creating content in such a way
                that search engines rank your page high on the search engine results page.SEO helps you to
              ...
              <li>
                <strong>Social Media Marketing</strong> is the platform for digital marketing that assists you
                to reach out to your new customers and create profiles or posts to advertise new products,
                sales or newly published content.
              </li>
              <li>
                <strong>Content marketing</strong> refers to informational and valuable content post blog that
                helps you connect with your audience and answer their questions and it also generates leads
                and increases sales
              </li>
              <li>
                <strong>Email Marketing</strong> is used to send emails about sales, special events or product
                releases to your customers. Through email marketing, you can establish a mutual relationship
                with your customers that will increase your brand loyalty.
              </li>
              <li>
              ...
              <li>
                <strong>Video Marketing</strong> Video content is reliable digital marketing that helps you to
                connect with your customers or masses and spread your product information effectively.
              </li>
              <li>
                <strong>Audio Marketing</strong> refers to the marketing in which the audio content is used to
                promote a business and products or services brand. Audio marketing helps you to meet your
                target audience at personal level and generate leads through digital audio devices like radio,
                podcast, telephone and many more.
              </li>
              <li>
                <strong>Affiliate Marketing</strong> helps you to enhance your customer's reach by engaging
                with their existing audience. It helps you promote your business or products and share a link
                to your website.
              </li>
              <li>
        ...
        <div className='w-10/12 mx-auto'>
          <div className='sm:p-5 md:p-10'>
            ...
            <p>
              Google is a search engine that organises world’s information offered by web servers and makes it
              globally accessible and beneficial. Google is the world’s top search engine that collects the
              information from the web servers and ranks the page on the basis of its content. This is the
              only Google that brings any website on the top of the search engine results page (SERP).
              Google’s algorithm uses hundred of metrics to rank your website. For this, you have to earn
              Google’s trust. If you are not trusted by Google, you won’t simply reach that top in the search
              engines. You can earn Google’s trust for digital marketing by following the listed below tips.
            </p>
          ...
          <div className='sm:px-5 md:px-10 py-4'>
            ...
            <ul className='list-disc py-5 px-8 sm:px-12 md:px-16'>
              ...
              <li>
                You must have ability to analyse the data means you are required to understand the concept of
                the data such as update the data and remove unwanted data to make effective decision.
              </li>
              <li>
                A digital marketer must be skilled in high quality content creation because digital marketing
                is based on the content that pulls company target audience to the brand.
              </li>
              <li>
        ...
        <div className='w-10/12 mx-auto flex flex-col md:flex-row justify-center items-center gap-8 py-6'>
          ...
          <div className='w-full text-center'>
            ...
            <p>
              ...
              A/B testing is one way to find out — and a great way to optimize your campaigns. Test different
              email subject line formulas, content formats and CTAs. See which ones get the best engagement
              and stick with the approach.
            </p>
          </div>
        </div>
      </div>
