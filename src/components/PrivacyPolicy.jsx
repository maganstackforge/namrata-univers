        ...
        <div className='p-6'>
          <section className='py-2 sm:px-2'>
            ...
            <p>
              ...
              collect the personal information you give us such as your name, address and email address. When
              you browse our store, we also automatically receive your computer’s internet protocol (IP)
          ...
          <section className='py-2 sm:px-2'>
            ...
            <p>
              ...
              handling of credit card information by our store and its service providers. For more insight,
              you may also want to read terms and conditions of razorpay on https://razorpay.com
            </p>
          </section>
          <section className='py-2 sm:px-2'>
            ...
            <p>
              ...
              jurisdiction(s) in which that service provider or its facilities are located. Once you leave our
              store’s website or are redirected to a third-party website or application, you are no longer
          ...
          <section className='py-2 sm:px-2'>
            ...
            <p>
              ...
              any, we use and/or disclose it. If our store is acquired or merged with another company, your
